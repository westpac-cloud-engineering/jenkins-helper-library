def call(body) {
    ...
    node {
        ...
        stage ('Apply') {
            ...
            sh "set +e; python3 helper_scripts/terraform_enterprise_2/run_jobs/run_terraform_apply.py \'${config.app_id}\' \'${config.component_name}\' \'${config.environment}\' \'${config.plan_info.run_id}\' \'${config.destroy_flag}\'  "
