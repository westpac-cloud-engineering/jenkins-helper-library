def call(body) {
    ...
    node {
        ...
        stage ('Apply') {
            ...
            sh "set +e; python3 terraform_enterprise_2/run_jobs/run_terraform_apply.py \'${config.organisation}\' \'${config.app_id}\' \'${config.workspace_name}\' \'${plan_info.props['run_id']}\' \'${config.destroy_infrastructure}\' \'${config.atlas_token}\'"
